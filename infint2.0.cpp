...
public:
    ...
    inline InfInt(int l);
    inline InfInt(long l);
    inline InfInt(long long l);
    inline InfInt(unsigned int l);
    inline InfInt(unsigned long l);
    inline InfInt(unsigned long long l);

    /* assignment operators */
    inline const InfInt& operator=(const char* c);
    inline const InfInt& operator=(const std::string& s);
    inline const InfInt& operator=(int l);
    inline const InfInt& operator=(long l);
    inline const InfInt& operator=(long long l);
    inline const InfInt& operator=(unsigned int l);
    inline const InfInt& operator=(unsigned long l);
    inline const InfInt& operator=(unsigned long long l);

    /* unary increment/decrement operators */
    inline const InfInt& operator++();
    inline const InfInt& operator--();
    inline InfInt operator++(int);
    inline InfInt operator--(int);

    /* operational assignments */
    inline const InfInt& operator+=(const InfInt& rhs);
    inline const InfInt& operator-=(const InfInt& rhs);
    inline const InfInt& operator*=(const InfInt& rhs);
    inline const InfInt& operator/=(const InfInt& rhs); // throw
    inline const InfInt& operator%=(const InfInt& rhs); // throw
    inline const InfInt& operator*=(ELEM_TYPE rhs);
    inline InfInt operator^=(const InfInt& rhs);		// pow

    /* operations */
    inline InfInt operator-() const;
    inline InfInt operator+(const InfInt& rhs) const;
    inline InfInt operator-(const InfInt& rhs) const;
    inline InfInt operator*(const InfInt& rhs) const;
    inline InfInt operator/(const InfInt& rhs) const; 	// throw
    inline InfInt operator%(const InfInt& rhs) const; 	// throw
    inline InfInt operator*(ELEM_TYPE rhs) const;
    inline InfInt operator^(const InfInt& rhs) const;	// pow

    /* relational operations */
    inline bool operator==(const InfInt& rhs) const;
    inline bool operator!=(const InfInt& rhs) const;
    inline bool operator<(const InfInt& rhs) const;
    inline bool operator<=(const InfInt& rhs) const;
    inline bool operator>(const InfInt& rhs) const;
    ...
    /* integer square root */
    inline InfInt intSqrt() const; // throw
    inline InfInt sqrt(){return intSqrt();} // throw

    /* digit operations */
    inline char digitAt(size_t i) const; // throw
    inline size_t numberOfDigits() const;
    ...
    inline long toLong() const; // throw
    inline long long toLongLong() const; // throw
...
//private:
    ...
    inline void optimizeSqrtSearchBounds(InfInt& lo, InfInt& hi) const;
    inline void truncateToBase();
    inline bool equalizeSigns();
...
inline InfInt InfInt::operator^=(const InfInt& rhs)	// pow
{
    InfInt ans = 1;
...
inline InfInt InfInt::operator^(const InfInt& rhs) const	// pow
{
    InfInt ans = 1;
    for( InfInt i = 0; i < rhs; i++ )
    {
...
/*inline InfInt operator ^= (InfInt &a, InfInt b)
{
    InfInt ans = 1;
    for( InfInt i = 0; i < b; i++ )
    {
        ans *= a;
    }
    a = ans;
...
inline InfInt operator ^= (InfInt &a, int b)
{
    InfInt ans = 1;
    for( int i = 0; i < b; i++ )
    {
...
inline InfInt pow( InfInt a, InfInt b )
{
    InfInt ans = 1;
    for( InfInt i = 0; i < b; i++ )
    {
...
inline InfInt pow( InfInt a, int b )
{
    InfInt ans = 1;
    for( int i = 0; i < b; i++ )
    {
